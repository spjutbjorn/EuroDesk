...
**Category:** Whistleblowing & Compliance
**Type:** Self-hosted
**Jurisdiction:** EU (Italy)
**Website:** [globaleaks.org](https://www.globaleaks.org/)

## What It Is
GlobaLeaks is an open-source, free whistleblowing software developed by the Hermes Center for Transparency and Digital Human Rights in Italy. It empowers organizations to set up secure, anonymous reporting channels.
...
- Extremely strict privacy controls by design, making it the sovereign standard for ethical reporting and risk management.
